...
/**
 * Servlet implementation class ArquivosServicoTerceiros
 */
public class ArquivosServicoTerceiros extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ArquivosServicoTerceiros() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			prop.load(in);
			String dirArquivos = prop.getProperty("dir.anexos.servTerceiros");
