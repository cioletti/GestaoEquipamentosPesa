...
/**
 * Servlet implementation class VisualizarDetalhes
 */
public class VisualizarDetalhes extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String idTipoServTerceiro = request.getParameter("idTipoServTerceiro");
		
		try {
			SituacaoServicoTerceirosBusiness business = new SituacaoServicoTerceirosBusiness(null);
			String caminho = business.findCaminhoArquivoDetalhes(idSegmento+"_"+idTipoServTerceiro);

			File arquivo = null;
			String nomeFile = business.recuperarNomeArquivoDetalhes(idSegmento+"_"+idTipoServTerceiro);
