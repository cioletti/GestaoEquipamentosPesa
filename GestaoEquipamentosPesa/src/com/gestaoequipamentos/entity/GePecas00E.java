...
@Entity
@Table(name = "GE_PECAS_00E")

public class GePecas00E implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GePecas00E)) {
            return false;
        }
        GePecas00E other = (GePecas00E) object;
